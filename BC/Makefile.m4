...
#  	   Responder                                                                                      
# 1	DisplayOnly                  JW               JW             PE                JW            
# 2	DisplayYesNo                 JW        JW(Legacy)/NC(SC)     PE                JW      
# 3	KeyboardOnly                 PE               PE             PE                JW            
# 4	NoInputNoOutput              JW               JW             JW                JW            
...
test:
	m4 CMDDefine($(word 1, $(IOCapabilitys)),1,1,1,$(word 1, $(IOCapabilitys)),1,1,1) $(File) > ./test.spthy
	dnl tamarin-prover $(Heuristic_S) --prove=$(Lemma) ./test.spthy --output=./Out_test.spthy
    tamarin-prover $(Heuristic_S) --prove=$(Lemma) ./test.spthy
...
<!m4 CMDDefine($(word $1, $(IOCapabilitys)),$2,$3,$4,$(word $5, $(IOCapabilitys)),$6,$7,$8) $(File) > ./$($9)/SSP_SC-ifelse($2$3$6$7,0000,$(word $1, $(IOCapabilitys))_$(word $5, $(IOCapabilitys)),$2$3$6$7).spthy!>)
define(TamarinProve,
<!tamarin-prover $(Heuristic_S) --prove=$(Lemma) ./$($9)/SSP_SC-ifelse($2$3$6$7,0000,$(word $1, $(IOCapabilitys))_$(word $5, $(IOCapabilitys)),$2$3$6$7).spthy --output=./$($9)/proofs/Out_$(fnLemma)_SSP_SC-ifelse($2$3$6$7,0000,$(word $1, $(IOCapabilitys))_$(word $5, $(IOCapabilitys)),$2$3$6$7).spthy > .tmp
	echo >> ./$($9)/proofs/Out_$(fnLemma)_SSP_SC-ifelse($2$3$6$7,0000,$(word $1, $(IOCapabilitys))_$(word $5, $(IOCapabilitys)),$2$3$6$7).spthy
	cat .tmp >> ./$($9)/proofs/Out_$(fnLemma)_SSP_SC-ifelse($2$3$6$7,0000,$(word $1, $(IOCapabilitys))_$(word $5, $(IOCapabilitys)),$2$3$6$7).spthy !>)
changequote
divert(0)dnl
dnl ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
JW:
...
divert(0)dnl
dnl ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	m4 CMDDefine($(word 5, $(IOCapabilitys)),0,0,0,$(word 5, $(IOCapabilitys)),0,0,0) $(File) > ./$(JWDir)/SSP_SC-No_OOB-No_MITM.spthy
	tamarin-prover $(Heuristic_S) --prove=$(Lemma) ./$(JWDir)/SSP_SC-No_OOB-No_MITM.spthy --output=./$(JWDir)/proofs/Out_$(fnLemma)_SSP_SC-No_OOB-No_MITM.spthy > .tmp
	echo >> ./$(JWDir)/proofs/Out_$(fnLemma)_SSP_SC-No_OOB-No_MITM.spthy
	cat .tmp >> ./$(JWDir)/proofs/Out_$(fnLemma)_SSP_SC-No_OOB-No_MITM.spthy
	...
	dnl JW_Generate_Prove(5,4)
	dnl JW_Generate_Prove(4,5)
	# rm .tmp
...
dnl ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	...
	dnl NC_Generate_Prove(5,2)
	dnl NC_Generate_Prove(2,5)
	dnl NC_Generate_Prove(5,5)
	# rm .tmp
...
dnl ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	...
	dnl PE_Generate_Prove(5,1)
	PE_Generate_Prove(3,2)
	PE_Generate_Prove(1,3)
	PE_Generate_Prove(2,3)
	PE_Generate_Prove(3,3)
	dnl PE_Generate_Prove(5,3)
	dnl PE_Generate_Prove(1,5)
	dnl PE_Generate_Prove(3,5)
	# rm .tmp
