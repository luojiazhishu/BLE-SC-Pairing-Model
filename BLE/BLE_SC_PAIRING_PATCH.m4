...
functions: f4/4, g2/4, f5/5, f6/7, resize/2, h/1
...
rule InitDRequest [color=#BBFFFF]:
    let
        OOBflagI = '0'
        KeySizeInit = '16'
        request = <MacAddI,MacAddR,InitD,'Req',IOCapabilityI,OOBflagI,MITMI,KeySizeInit>
    in
    [
        State_Scaned(InitD,MacAddI,IOCapabilityI,MITMI,~skI,ResD,MacAddR)
    ]
...
rule ResDSResponse [color=#FFF68F]:
    let
        ...
        KeySizeRes = '16'
        request = <MacAddI,MacAddR,InitD,'Req',IOCapabilityI,OOBflagI,MITMI,KeySizeInit>
        response = <MacAddR,MacAddI,'response',IOCapabilityR,OOBflagR,MITMR,KeySizeRes>
    in
    [
...
rule NC_ResDReDisplay [color=#FFF68F]:
    let
        Vb = g2(DHpkI,'g'^~skR,Na,~Nb)
        Db = h(<Vb,request,response>)
    in
    [
        NC_State_Res_Displayed(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb),
    ...
    [
        Out_A(<'DisplayConfirm','Device','User'>,ResD,$User,Db),
        NC_State_Res_ReDisplayed(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb)
    ]

rule NC_InitDReDisplay [color=#BBFFFF]:
    let
        Va = g2('g'^~skI,DHpkR,~Na,Nb)
        Da = h(<Va,request,response>)
    in
    [
        NC_State_Init_Displayed(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb),
    ...
    [
        Out_A(<'DisplayConfirm','Device','User'>,InitD,$User,Da),
        NC_State_Init_ReDisplayed(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb)
    ]
...
define(Generate_PE_InitDDisplay1,
<!rule PE_InitDDisplay1_$1_$2 [color=#BBFFFF]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        ...
        PE_InitDDisplayed1(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,~r)
    ]!>)

define(Generate_PE_InitDAskforInput1,
<!rule PE_InitDAskforInput1_$1_$2 [color=#BBFFFF]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        ...
        PE_InitDWaitInput1(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI)
    ]!>)

define(Generate_PE_ResDDisplay1,
<!rule PE_ResDDisplay1_$1_$2 [color=#FFF68F]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        ...
        PE_ResDDisplayed1(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,~r)
    ]!>)

define(Generate_PE_ResDAskforInput1,
<!rule PE_ResDAskforInput1_$1_$2 [color=#FFF68F]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        ...
        PE_ResDWaitInput1(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR)
    ]!>)

changequote
divert(0)dnl
//Initiator Device Display
Generate_PE_InitDDisplay1(DisplayOnly,KeyboardOnly)
Generate_PE_InitDDisplay1(DisplayYesNo,KeyboardOnly)
Generate_PE_InitDDisplay1(KeyboardDisplay,KeyboardOnly)
Generate_PE_InitDDisplay1(DisplayOnly,KeyboardDisplay)

//Initiator Device Ask for Input
Generate_PE_InitDAskforInput1(KeyboardOnly,DisplayOnly)
Generate_PE_InitDAskforInput1(KeyboardDisplay,DisplayOnly)
Generate_PE_InitDAskforInput1(KeyboardOnly,DisplayYesNo)
Generate_PE_InitDAskforInput1(KeyboardOnly,KeyboardOnly)
Generate_PE_InitDAskforInput1(KeyboardOnly,KeyboardDisplay)

//Responder Device Display
Generate_PE_ResDDisplay1(KeyboardOnly,DisplayOnly)
Generate_PE_ResDDisplay1(KeyboardDisplay,DisplayOnly)
Generate_PE_ResDDisplay1(KeyboardOnly,DisplayYesNo)
Generate_PE_ResDDisplay1(KeyboardOnly,KeyboardDisplay)

//Responder Device Ask for Input
Generate_PE_ResDAskforInput1(DisplayOnly,KeyboardOnly)
Generate_PE_ResDAskforInput1(DisplayYesNo,KeyboardOnly)
Generate_PE_ResDAskforInput1(KeyboardOnly,KeyboardOnly)
Generate_PE_ResDAskforInput1(KeyboardDisplay,KeyboardOnly)
Generate_PE_ResDAskforInput1(DisplayOnly,KeyboardDisplay)
...
rule PE_ResDCheckSendNonceOK [color=#FFF68F]:
    ...
    [
        Out(<MacAddR,MacAddI,~Nb>),
        State_ResDChecked1(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb)
    ]
...
rule PE_InitDCheckOK [color=#BBFFFF]:
    ...
    [
        State_InitDChecked1(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb)
    ]

divert(-1)
changequote(<!,!>)

define(Generate_PE_InitDDisplay2,
<!rule PE_InitDDisplay2_$1_$2 [color=#BBFFFF]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
        IOCapabilityR = '$2'
        DI = h(<ra,request,response>)
    in
    [
        State_InitDChecked1(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb),
        !InitDSaveReqResPair(request,response)
    ...
    --[ ]->
    [
        Out_A(<'Display','Device','User'>,InitD,$User,DI),
        State_Init_OK(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb)
    ]!>)

define(Generate_PE_InitDAskforInput2,
<!rule PE_InitDAskforInput2_$1_$2 [color=#BBFFFF]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        Out_A(<'AskforInput','Device','User'>,InitD,$User,'Input'),
        PE_InitDWaitInput2(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb)
    ]!>)

define(Generate_PE_ResDDisplay2,
<!rule PE_ResDDisplay2_$1_$2 [color=#FFF68F]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
        IOCapabilityR = '$2'
        DR = h(<rb,request,response>)
    in
    [
        State_ResDChecked1(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb),
        !ResDSaveReqResPair(request,response)
    ...
    --[ ]->
    [
        Out_A(<'Display','Device','User'>,ResD,$User,DR),
        State_Res_OK(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb)
    ]!>)

define(Generate_PE_ResDAskforInput2,
<!rule PE_ResDAskforInput2_$1_$2 [color=#FFF68F]:
    let
        OOBflagI = '0'
        OOBflagR = '0'
        IOCapabilityI = '$1'
    ...
    [
        Out_A(<'AskforInput','Device','User'>,ResD,$User,'Input'),
        PE_ResDWaitInput2(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb)
    ]!>)
...
//Initiator Device Display
Generate_PE_InitDDisplay2(DisplayOnly,KeyboardOnly)
Generate_PE_InitDDisplay2(DisplayYesNo,KeyboardOnly)
Generate_PE_InitDDisplay2(KeyboardDisplay,KeyboardOnly)
Generate_PE_InitDDisplay2(DisplayOnly,KeyboardDisplay)

//Initiator Device Ask for Input
Generate_PE_InitDAskforInput2(KeyboardOnly,DisplayOnly)
Generate_PE_InitDAskforInput2(KeyboardDisplay,DisplayOnly)
Generate_PE_InitDAskforInput2(KeyboardOnly,DisplayYesNo)
Generate_PE_InitDAskforInput2(KeyboardOnly,KeyboardDisplay)

//Responder Device Display
Generate_PE_ResDDisplay2(KeyboardOnly,DisplayOnly)
Generate_PE_ResDDisplay2(KeyboardDisplay,DisplayOnly)
Generate_PE_ResDDisplay2(KeyboardOnly,DisplayYesNo)
Generate_PE_ResDDisplay2(KeyboardOnly,KeyboardDisplay)

//Responder Device Ask for Input
Generate_PE_ResDAskforInput2(DisplayOnly,KeyboardOnly)
Generate_PE_ResDAskforInput2(DisplayYesNo,KeyboardOnly)
Generate_PE_ResDAskforInput2(KeyboardDisplay,KeyboardOnly)
Generate_PE_ResDAskforInput2(DisplayOnly,KeyboardDisplay)



rule PE_InitDUserInput2OK [color=#BBFFFF]:
    [
        PE_InitDWaitInput2(InitD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skI,DHpkR,DHKeyI,ra,rb,~Na,Nb),
...
rule PE_ResDUserInput2OK [color=#FFF68F]:
    [
        PE_ResDWaitInput2(ResD,MacAddI,IOCapabilityI,OOBflagI,MITMI,MacAddR,IOCapabilityR,OOBflagR,MITMR,~skR,DHpkI,DHKeyR,ra,rb,Na,~Nb),
...
rule PE_InitDOK_KeyboardOnly_KeyboardOnly [color=#BBFFFF]:
    let
...
rule PE_ResDOK_KeyboardOnly_KeyboardOnly [color=#FFF68F]:
    let
        IOCapabilityI = 'KeyboardOnly'
        IOCapabilityR = 'KeyboardOnly'
    in
